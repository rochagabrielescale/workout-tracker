// Sample data for the BLOOM prototype
...
export const ACTIVE = {
  ...
  currentIdx: 0,
  list: [
    { name: 'Barbell Row', type: 'Barbell · Bent-over · 4 × 6-8',
      ...
      target: 4 },
    { name: 'Lat Pulldown', type: 'Cable · Wide · 3 × 8-10',
      last: { date: 'APR 15', vals: '160 × 10 · 10 · 9' }, sets: [], target: 3 },
    { name: 'Chest-Supp Row', type: 'Machine · 3 × 10-12',
      last: { date: 'APR 15', vals: '110 × 12 · 12 · 11' }, sets: [], target: 3 },
    { name: 'Face Pull', type: 'Cable · Rope · 3 × 12-15',
      last: { date: 'APR 12', vals: '40 × 15 · 15 · 12' }, sets: [], target: 3 },
    { name: 'Hammer Curl', type: 'DB · 3 × 10',
      last: { date: 'APR 15', vals: '35 × 10 · 10 · 9' }, sets: [], target: 3 },
    { name: 'Incline DB Curl', type: 'DB · 3 × 12',
      last: { date: 'APR 12', vals: '25 × 12 · 12 · 11' }, sets: [], target: 3 },
  ],
};
...
export const STATS = {
  ...
  volumeDelta: 12.4,
  weeks: [
    { w: 'W1', v: 142 }, { w: 'W2', v: 151 }, { w: 'W3', v: 138 },
    { w: 'W4', v: 160 }, { w: 'W5', v: 155 }, { w: 'W6', v: 168 },
    { w: 'W7', v: 162 }, { w: 'W8', v: 175, live: true },
  ],
...
export const MEASUREMENTS = {
  bw:    { val: 178.2, unit: 'LB', delta: -3.8, series: [182, 181.5, 181, 180.5, 180, 180, 179.5, 179, 178.8, 178.5, 178.4, 178.2] },
  bf:    { val: 14.2,  unit: '%',  delta: -1.6, series: [15.8, 15.6, 15.4, 15.2, 15, 14.9, 14.7, 14.6, 14.5, 14.4, 14.3, 14.2] },
